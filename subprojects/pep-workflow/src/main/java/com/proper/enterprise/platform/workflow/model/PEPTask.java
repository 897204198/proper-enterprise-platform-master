...
public class PEPTask {
    ...
    public String getAssigneeName() {
        ...
        User user = PEPApplicationContext.getApplicationContext().getBean(UserDao.class).findOne(this.getAssignee());
        if (null == user) {
            return null;
        }
        return user.getName();
    ...
    public Set<String> getCandidateRoleNames() {
        ...
        List<Role> roles = new ArrayList<>(PEPApplicationContext.getBean(RoleDao.class).findAll(this.getCandidateRoles()));
