...
INSERT INTO pep_auth_menus (id, name, route, icon, parent_id, sequence_number, menu_type) VALUES ('pep-workflow-designer', '流程设计',
'workflow/designer', 'share-alt', 'pep-workflow', '0', 'MENU_TYPE;1');
