...
(id, create_user_id, create_time, last_modify_user_id, last_modify_time, code, name, parent_res_id, resource_type, url, method, sequence_number)
VALUES
...
(id, create_user_id, create_time, last_modify_user_id, last_modify_time, code, name, parent_res_id, resource_type, url, method, sequence_number)
VALUES
('20160120164030', 'sys', '2015-08-18 09:38:00', 'sys', '2015-08-18 09:38:00', 'workflow.instances', '流程实例', 'BBD7A5193ECC493DB202A7F0DECF386C', 'MENU', '/workflow/instances', 'GET', 1);

INSERT INTO pep_auth_resources
(id, create_user_id, create_time, last_modify_user_id, last_modify_time, code, name, parent_res_id, resource_type, url, method, sequence_number)
VALUES
('20160120164230', 'sys', '2015-08-18 09:38:00', 'sys', '2015-08-18 09:38:00', 'workflow.instances.list', '流程实例列表', 'BBD7A5193ECC493DB202A7F0DECF386C', 'API', '/workflow/service/runtime/process-instances', 'GET', 1);
