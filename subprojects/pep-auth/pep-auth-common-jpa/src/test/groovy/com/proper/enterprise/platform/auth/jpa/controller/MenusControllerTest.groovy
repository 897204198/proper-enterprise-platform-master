package com.proper.enterprise.platform.auth.jpa.controller
...
@Sql([
    "/com/proper/enterprise/platform/auth/jpa/resources.sql",
    "/com/proper/enterprise/platform/auth/jpa/menus.sql",
    "/com/proper/enterprise/platform/auth/jpa/menus-resources.sql",
    "/com/proper/enterprise/platform/auth/jpa/roles.sql",
    "/com/proper/enterprise/platform/auth/jpa/roles-menus.sql",
    "/com/proper/enterprise/platform/auth/jpa/users.sql",
    "/com/proper/enterprise/platform/auth/jpa/users-roles.sql",
    "/com/proper/enterprise/platform/auth/jpa/datadics.sql"
])
class MenusControllerTest extends AbstractTest {
    ...
    @Sql("/com/proper/enterprise/platform/auth/jpa/datadics.sql")
    @Test
    void testMenuType() {
        menuType.getCatalog()
