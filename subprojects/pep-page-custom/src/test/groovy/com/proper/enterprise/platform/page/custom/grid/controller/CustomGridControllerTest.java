...
public class CustomGridControllerTest extends AbstractTest {

    @Autowired
    private CustomGridRepository customGridRepository;

    @Test
    public void testGetCustomGridForPage() throws Exception {
    ...
    @Test
    public void testGetCustomGridByCode() throws Exception {
    ...
    @Test
    public void testGetCustomGridById() throws Exception {
    ...
    @Test
    public void testSaveCustomGrid() throws Exception {
    ...
    @Test
    public void testUpdateCustomGrid() throws Exception {
        Map<String, Object> param = new HashMap<String, Object>();
        param.put("title", "测试数据3");
        param.put("code", "test3");
        param.put("tableName", "table_test3");
    ...
    @Test
    public void testDeleteCustomGrid() throws Exception {
