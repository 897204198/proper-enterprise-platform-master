...
public class RdbOperationControllerTest extends AbstractTest {
    ...
    @Test
    public void testGetDataForList() throws Exception {
    ...
    @Test
    public void testGetDataForPage() throws Exception {
    ...
    public void saveTestData() throws Exception {
        ...
        jdbcTemplate.execute("CREATE TABLE table_test (id varchar(255) primary key not null, name varchar(255), create_user_id varchar(255), create_time varchar(255), last_modify_user_id varchar(255), last_modify_time varchar(255))");
