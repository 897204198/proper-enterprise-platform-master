...
class ApiNoticeSendResourceTest extends AbstractTest {
    ...
    public void sendNoticeValidTest() {
        ...
        def accessToken = new AccessTokenVO('sendNoticeTest', 'for test using', "sendNoticeTest", 'GET:/test')
        ...
        //测批次号长度
        assert I18NUtil.getMessage("notice.server.param.batchId.isTooLong") == post("/notice/server/send?accessToken=sendNoticeTest",
        ...
        assert I18NUtil.getMessage("notice.server.param.targetExtMsg.isTooLong") == post("/notice/server/send?accessToken=sendNoticeTest",
            JSONUtil.toJSON(noticeRequest), HttpStatus.INTERNAL_SERVER_ERROR).getResponse().getContentAsString()
        //测notice扩展信息长度
        ...
        assert I18NUtil.getMessage("notice.server.param.noticeExtMsg.isTooLong") == post("/notice/server/send?accessToken=sendNoticeTest",
            JSONUtil.toJSON(noticeRequest), HttpStatus.INTERNAL_SERVER_ERROR).getResponse().getContentAsString()
        //测targetTo为空
        ...
        target.setTo("")
        assert I18NUtil.getMessage("notice.server.param.target.cantBeEmpty") == post("/notice/server/send?accessToken=sendNoticeTest",
            JSONUtil.toJSON(noticeRequest), HttpStatus.INTERNAL_SERVER_ERROR).getResponse().getContentAsString()
    }
    ...
    public void sendNoticeSuccessTest() {
        ...
        noticeRequest.setTargets(targets)
        noticeRequest.setNoticeExtMsg("noticeExt", "noticeExt")
        post("/notice/server/send?accessToken=sendNoticeTest", JSONUtil.toJSON(noticeRequest), HttpStatus.CREATED)
        Thread.sleep(5000)
        ...
        noticeRepository.deleteAll()
        accessTokenService.deleteByToken("sendNoticeTest")
    }
    ...
    public void sendNoticeErrTest() {
        noticeRepository.deleteAll()
        def accessToken = new AccessTokenVO('mockErrSend', 'for test using', "mockErrSend", 'GET:/test')
        accessTokenService.saveOrUpdate(accessToken)
        NoticeRequest noticeRequest = new NoticeRequest()
        ...
        noticeRequest.setTargets(targets)
        noticeRequest.setNoticeExtMsg("noticeExt", "noticeExt")
        post("/notice/server/send?accessToken=mockErrSend", JSONUtil.toJSON(noticeRequest), HttpStatus.CREATED)
        Thread.sleep(5000)
    ...
    public void sendNoticeRetryTest() {
        noticeRepository.deleteAll()
        def accessToken = new AccessTokenVO('mockRetryStatus', 'for test using', "mockRetryStatus", 'GET:/test')
        accessTokenService.saveOrUpdate(accessToken)
        NoticeRequest noticeRequest = new NoticeRequest()
        ...
        noticeRequest.setTargets(targets)
        noticeRequest.setNoticeExtMsg("noticeExt", "noticeExt")
        post("/notice/server/send?accessToken=mockRetryStatus", JSONUtil.toJSON(noticeRequest), HttpStatus.CREATED)
        Thread.sleep(5000)
