...
class ApplicationControllerTest extends AbstractJPATest {
    @Autowired
    ...
    void catalogOfMethods() {
        ...
        delete("/admin/app/applications/catalogs/${appCatalog3.code}", HttpStatus.NO_CONTENT)
        ...
        delete("/admin/app/applications/catalogs/${appCata.code}", HttpStatus.INTERNAL_SERVER_ERROR).getResponse().getContentAsString() ==
