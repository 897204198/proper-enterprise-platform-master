...
public class AliPayServiceImpl extends AbstractPayImpl implements PayService, AliPayService {
    ...
    protected <T> T getPayQueryRes(String outTradeNo) {
        ...
        String method = payAliProperties.getTradeQueryMethod();
        String responseKey = "alipay_trade_query_response";
        Object result = getAliRequestRes(res,
            bizContentMap,
            method,
            responseKey,
            payAliProperties.getPrivateKeyForPay(),
            payAliProperties.getSignTypeForPay(),
            rsaPay);
        return (T) result;
    }
    ...
    protected <T> T saveRefundProcess(T refundBody) throws Exception {
        ...
        String method = payAliProperties.getTradeRefundMethod();
        ...
        Object result = getAliRequestRes(res,
            ...
            method,
            responseKey,
            payAliProperties.getPrivateKeyForRefund(),
            payAliProperties.getSignTypeForRefund(),
            rsaRefund);
        if (result != null) {
    ...
    protected <T> T getRefundQueryRes(String orderNo, String refundNo) {
        ...
        bizContentMap.put("out_request_no", refundNo);
        String method = payAliProperties.getTradeRefundQueryMethod();
    ...
    protected Object getAliRequestRes(Object res,
        ...
        try {
            ...
            if (null != body) {
                strRead = new String(body, coreProperties.getCharset());
            }
        ...
        for (String fieldName : set) {
            if (!StringUtil.startsWith(fieldName, "$")) {
                ...
                if ("trade_status".equals(paramName) && StringUtil.isNull(params.get("trade_status"))) {
                    alipayinfo.setTradeStatus(payAliProperties.getNoticeTradeStatusUnknown());
                    // 交易金额
                    ...
                    alipayinfo.setRefundStatus(payAliProperties.getNoticeTradeStatusUnknown());
                    // 其他情况
                } else {
    ...
    private String verifyResponse(String notifyId) throws IOException {
        ...
        String partner = payAliProperties.getPartnerId();
        StringBuilder veryfyUrl = new StringBuilder();
        veryfyUrl.append(payAliProperties.getHttpsVerifyUrl()).append("partner=").append(partner)
    ...
    private boolean getSignVeryfy(Map<String, String> params, String sign) throws Exception {
        ...
        // 获得签名验证结果
        return "RSA".equals(payAliProperties.getSignTypeForPay())
            && rsaPay.verifySign(preSignStr, sign, payAliProperties.getAliPublicKey());
    }
