...
public class DateUtil {
    ...
    public static Date parseGMTSpecial(String dateTimestamp) {
        SimpleDateFormat sdf = new SimpleDateFormat(dateTimestamp.length() > 10
            ? PEPPropertiesLoader.load(CoreProperties.class).getAntdTimestampFormat()
            : PEPPropertiesLoader.load(CoreProperties.class).getDefaultDateFormat());
    ...
    public static LocalDateTime parseGMTSpecialToLocalDateTime(String dateTimestamp) {
        String pattern = dateTimestamp.length() > 10 ? PEPPropertiesLoader.load(CoreProperties.class).getAntdTimestampFormat()
            : PEPPropertiesLoader.load(CoreProperties.class).getDefaultDateFormat();
