...
class SortTest extends AbstractTest {
    ...
    public void sortTest() {
        ...
        DataTrunk<OneEntity> dataTrunk1 = JSONUtil.parse(get("/one?pageNo=1&pageSize=2&orders=" + URLEncoder.encode(JSONUtil.toJSON(orders), PEPConstants.DEFAULT_CHARSET.name()), HttpStatus.OK).getResponse().getContentAsString(), DataTrunk.class)
