...
public class CmbRefundNoDupHeadReq implements Serializable {
    ...
    private String password = ConfCenter.get("pay.cmb.operatorPassword");
    ...
    private String command = ConfCenter.get("pay.cmb.refundNoDup");
