...
public class WechatConstants {
    ...
    // API密钥
    public final static String WECHAT_PAY_API_KEY = ConfCenter.get("pay.wechat.apiKey");
    // 微信异步通知地址
    public final static String WECHAT_PAY_URL_NOTICE = ConfCenter.get("pay.wechat.url.notify");
    /**------------微信支付接口地址------------------*/
    // 微信支付统一接口(POST)
    public final static String WECHAT_PAY_URL_UNIFIED = ConfCenter.get("pay.wechat.url.unified");
    // 微信退款接口(POST)
    public final static String WECHAT_PAY_URL_REFUND = ConfCenter.get("pay.wechat.url.refund");
    // 订单查询接口(POST)
    ...
    // 预支付校验失败
    public final static String WECHAT_PREPAY_VERIFY_ERROR = ConfCenter.get("pay.wechat.prepay.verifyError");
}
